...
// Lightweight meta shell template lives in shell.js (buildShell) — imported
// here and also reused by the regen script for rebuilding stored shells.
...
app.get('/s/:id', (req, res) => {
  ...
  res.set('Content-Type', 'text/html; charset=utf-8')
  res.set('Cache-Control', 'public, max-age=86400, s-maxage=604800, immutable')
  res.send(buildShell(PUBLIC_URL, meta, req.params.id))
})
